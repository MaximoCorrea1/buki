...
| **E4** | **R-6 / TM-13** — neither edge function bounded its upstream call | **[x]** | agent | `9fe7165` · 11/11, twice. *(This row said `da01ad9` for one commit — a hash written from MEMORY. `git log --oneline` is the probe.)* |
